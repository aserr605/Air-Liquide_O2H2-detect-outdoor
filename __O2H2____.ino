...
void loop() {
  ...
  {
  o2_s1 = 5;
  if (digitalRead(btn_o2_release) == HIGH)//系統異常蜂鳴解除 
  {
    Serial.println("if (digitalRead(btn_o2_release)==HIGH)//系統異常蜂鳴解除 "); 
    o2_s1 = 4;
  }
  }
  ...
  {
    H2_s1 = 5;
    if (digitalRead(btn_H2_release) == HIGH)//系統異常蜂鳴解除 
    {
      Serial.println("if (digitalRead(btn_H2_release)==HIGH)//系統異常蜂鳴解除 "); 
      H2_s1 = 4;
    }
  }
